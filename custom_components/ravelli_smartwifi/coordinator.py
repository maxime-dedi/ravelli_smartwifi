...
from .const import CONF_TOKEN, CONF_BASE_URL, CONF_SCAN_INTERVAL, CONF_DEBUG, DEFAULT_BASE_URL, DEFAULT_SCAN_INTERVAL, DOMAIN
...
class RavelliCoordinator(DataUpdateCoordinator):
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self.client = RavelliSmartWifiClient(session, base_url, token, debug=debug_enabled)
